...
export default function RefundSuccessful({
  modalPopVisible,
  closePopModal,
}: Readonly<Props>) {
  return (
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              our refund request and account details has been submitted, you
              will receive a notification and an email will be sent to{" "}
              <Text style={{ fontFamily: "outfit-bold", color: "#06782F" }}>
